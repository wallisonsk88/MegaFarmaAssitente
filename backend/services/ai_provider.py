...
SYSTEM_PROMPT = (
    ...
    "- Ao final da conversa, SOMENTE se o cliente se despedir ou agradecer (ex: 'tchau', 'obrigado', 'era só isso'), agradeça: 'Agradecemos sua visita à MegaFarma! Volte sempre!'\n"
